...
class ProductCouponModifier(object):
    """
    ...
    def __init__(self, created=None, changed_by=None, updated=None, id=None, organization_id=None, coupon_definition_id=None, effect_amount=None, operand=None, effect=None, effect_additional=False, specifier_amount=None, domain=None, specifier=None, precedence=None, deleted=False):
        """
        ProductCouponModifier - a model defined in Swagger
    ...
    def created(self):
        """
        Gets the created of this ProductCouponModifier.
        { \"description\" : \"The UTC DateTime when the object was created.\", \"verbs\":[] }

        :return: The created of this ProductCouponModifier.
        :rtype: datetime
        """
    ...
    def created(self, created):
        """
        Sets the created of this ProductCouponModifier.
        { \"description\" : \"The UTC DateTime when the object was created.\", \"verbs\":[] }

        :param created: The created of this ProductCouponModifier.
        :type: datetime
        """
    ...
    def changed_by(self):
        """
        Gets the changed_by of this ProductCouponModifier.
        { \"description\" : \"ID of the user who last updated the entity.\", \"verbs\":[] }

        :return: The changed_by of this ProductCouponModifier.
        :rtype: str
        """
    ...
    def changed_by(self, changed_by):
        """
        Sets the changed_by of this ProductCouponModifier.
        { \"description\" : \"ID of the user who last updated the entity.\", \"verbs\":[] }

        :param changed_by: The changed_by of this ProductCouponModifier.
        :type: str
        """
    ...
    def updated(self):
        """
        Gets the updated of this ProductCouponModifier.
        { \"description\" : \"The UTC DateTime when the object was last updated.\", \"verbs\":[] }

        :return: The updated of this ProductCouponModifier.
        :rtype: datetime
        """
    ...
    def updated(self, updated):
        """
        Sets the updated of this ProductCouponModifier.
        { \"description\" : \"The UTC DateTime when the object was last updated.\", \"verbs\":[] }

        :param updated: The updated of this ProductCouponModifier.
        :type: datetime
        """
    ...
    def id(self):
        """
        Gets the id of this ProductCouponModifier.
        { \"description\" : \"ID of the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :return: The id of this ProductCouponModifier.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ProductCouponModifier.
        { \"description\" : \"ID of the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param id: The id of this ProductCouponModifier.
        :type: str
        """
    ...
    def organization_id(self):
        """
        Gets the organization_id of this ProductCouponModifier.
        { \"description\" : \"ID of the organization associated with the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :return: The organization_id of this ProductCouponModifier.
        :rtype: str
        """
    ...
    def organization_id(self, organization_id):
        """
        Sets the organization_id of this ProductCouponModifier.
        { \"description\" : \"ID of the organization associated with the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param organization_id: The organization_id of this ProductCouponModifier.
        :type: str
        """
    ...
    def coupon_definition_id(self):
        """
        Gets the coupon_definition_id of this ProductCouponModifier.
        { \"description\" : \"The unique ID of the coupon-definition associated with the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :return: The coupon_definition_id of this ProductCouponModifier.
        :rtype: str
        """
    ...
    def coupon_definition_id(self, coupon_definition_id):
        """
        Sets the coupon_definition_id of this ProductCouponModifier.
        { \"description\" : \"The unique ID of the coupon-definition associated with the coupon-modifier.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param coupon_definition_id: The coupon_definition_id of this ProductCouponModifier.
        :type: str
        """
    ...
    def effect_amount(self, effect_amount):
        """
        Sets the effect_amount of this ProductCouponModifier.
        { \"description\" : \"The effect amount for the coupon-modifier. This is affected by the operand field.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param effect_amount: The effect_amount of this ProductCouponModifier.
        :type: float
        """
    ...
    def operand(self):
        """
        Gets the operand of this ProductCouponModifier.
        ...
        :return: The operand of this ProductCouponModifier.
        :rtype: str
        """
    ...
    def operand(self, operand):
        """
        Sets the operand of this ProductCouponModifier.
        { \"description\" : \"The operand field affects the effect amount of the coupon-modifier. If the operand is fixed, it is an exact amount of the currency defined by the coupon-definition. If the operand is percent, this means the coupon will be affecting a percentage of the unaltered cost. E.g. a 25% modifier will apply a 25% discount on a subscription or a pricing-component.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param operand: The operand of this ProductCouponModifier.
        :type: str
        """
    ...
    def effect(self):
        """
        Gets the effect of this ProductCouponModifier.
        ...
        :return: The effect of this ProductCouponModifier.
        :rtype: str
        """
        return self._effect
    ...
    def effect(self, effect):
        """
        Sets the effect of this ProductCouponModifier.
        { \"description\" : \"The effect of the coupon-modifier. The coupon-modifier can affect first, last, and cheapest value of a specific unit-of-measure-id for a subscription. The coupon-modifier can also affect all of the values for a unit-of-measure-id, or can affect all of the subscription cost.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param effect: The effect of this ProductCouponModifier.
        :type: str
        """
    ...
    def effect_additional(self):
        """
        Gets the effect_additional of this ProductCouponModifier.
        ...
        :return: The effect_additional of this ProductCouponModifier.
        :rtype: bool
        """
    ...
    def effect_additional(self, effect_additional):
        """
        Sets the effect_additional of this ProductCouponModifier.
        { \"description\" : \"Specifies whether the coupon-modifier will be affecting only additional units. If this field is set, the coupon-instance-existing-values for the coupon-instance are observed, and any units of the unit-of-measure-id defined by the modifier below the coupon-instance-existing-values for that unit-of-measure-id will be ignored.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param effect_additional: The effect_additional of this ProductCouponModifier.
        :type: bool
        """
    ...
    def specifier_amount(self):
        """
        Gets the specifier_amount of this ProductCouponModifier.
        ...
        :return: The specifier_amount of this ProductCouponModifier.
        :rtype: int
        """
    ...
    def specifier_amount(self, specifier_amount):
        """
        Sets the specifier_amount of this ProductCouponModifier.
        { \"description\" : \"The number of units that will be affected by the coupon-modifier, if the domain is set to uom\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param specifier_amount: The specifier_amount of this ProductCouponModifier.
        :type: int
        """
    ...
    def domain(self):
        """
        Gets the domain of this ProductCouponModifier.
        { \"description\" : \"The domain of the coupon-modifier\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :return: The domain of this ProductCouponModifier.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """
        Sets the domain of this ProductCouponModifier.
        { \"description\" : \"The domain of the coupon-modifier\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param domain: The domain of this ProductCouponModifier.
        :type: str
        """
    ...
    def specifier(self):
        """
        Gets the specifier of this ProductCouponModifier.
        ...
        :return: The specifier of this ProductCouponModifier.
        :rtype: str
        """
    ...
    def specifier(self, specifier):
        """
        Sets the specifier of this ProductCouponModifier.
        { \"description\" : \"The specifier is domain-specific. If the domain is uom, this field is used to limit the coupon-modifier to a specific unit-of-measure-id.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param specifier: The specifier of this ProductCouponModifier.
        :type: str
        """
    ...
    def precedence(self):
        """
        Gets the precedence of this ProductCouponModifier.
        ...
        :return: The precedence of this ProductCouponModifier.
        :rtype: int
        """
    ...
    def precedence(self, precedence):
        """
        Sets the precedence of this ProductCouponModifier.
        { \"description\" : \"The precedence of the coupon-modifier. This is used to order application of coupon-modifiers. Higher precedence means the coupon-modifier will be applied before others.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param precedence: The precedence of this ProductCouponModifier.
        :type: int
        """
    ...
    def deleted(self):
        """
        Gets the deleted of this ProductCouponModifier.
        { \"description\" : \"Has the coupon-modifier been deleted.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :return: The deleted of this ProductCouponModifier.
        :rtype: bool
        """
    ...
    def deleted(self, deleted):
        """
        Sets the deleted of this ProductCouponModifier.
        { \"description\" : \"Has the coupon-modifier been deleted.\", \"verbs\":[\"POST\",\"PUT\",\"GET\"] }

        :param deleted: The deleted of this ProductCouponModifier.
        :type: bool
        """
