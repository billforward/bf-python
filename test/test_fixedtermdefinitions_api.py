...
class TestFixedtermdefinitionsApi(unittest.TestCase):
    ...
    def test_create_fixed_term_definition(self):
        """
        Test case for create_fixed_term_definition

        Create
        """
        pass

    def test_update_fixed_term_definition(self):
        """
        Test case for update_fixed_term_definition
